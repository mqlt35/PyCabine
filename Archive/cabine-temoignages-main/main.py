...
def main():
    ...
    GPIO.add_event_detect(PIN_COMBINE, GPIO.FALLING, callback=DecrochageCombine, bouncetime=200)
    GPIO.add_event_detect(PIN_COMBINE, GPIO.RISING, callback=RaccrochageCombine, bouncetime=200)
